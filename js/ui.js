export class UIManager {
  ...
  updateCombo(combo) {
    ...
    if (combo < 2) { this._comboEl.classList.add('hidden'); return; }
  ...
  // ── Hint ─────────────────────────────────────────────────────
  setHint(text) { if (this._hintEl) this._hintEl.textContent = text; }
  ...
  // Final reward (kept for any potential use but no longer triggers by default)
